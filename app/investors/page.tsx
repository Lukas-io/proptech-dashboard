...
export const metadata: Metadata = generatePageMetadata({
  title: "Users",
  description: "Manage platform users, track activity, and oversee user portfolios and investments.",
  path: "/investors",
  keywords: ["user management", "platform users", "user activity", "user portfolios"],
});
    ...
    <PageTransition>
      <main className="mx-auto max-w-[1440px] px-4 py-6 sm:px-6 sm:py-8 md:px-16">
        <div className="mb-6 flex flex-col gap-4 sm:mb-8 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-xl font-semibold text-[#191919]">Users</h1>
            <p className="mt-1 text-sm text-[#606060]">Manage platform users and monitor activity</p>
          </div>
          <button
            type="button"
            disabled
        ...
        <div className="mb-6 grid gap-4 sm:grid-cols-4">
          <div className="rounded-xl border border-[#E4E4E4] bg-white p-4">
            <div className="text-sm font-medium text-[#525252]">Total Users</div>
            <p className="mt-2 text-2xl font-semibold text-[#4545FE]">{investors.length}</p>
          </div>
          <div className="rounded-xl border border-[#E4E4E4] bg-white p-4">
            <div className="text-sm font-medium text-[#525252]">Active</div>
            <p className="mt-2 text-2xl font-semibold text-[#12B76A]">{activeInvestors.length}</p>
          </div>
          <div className="rounded-xl border border-[#E4E4E4] bg-white p-4">
            <div className="text-sm font-medium text-[#525252]">Pending</div>
            <p className="mt-2 text-2xl font-semibold text-[#14B8A6]">{pendingInvestors.length}</p>
          </div>
          <div className="rounded-xl border border-[#E4E4E4] bg-white p-4">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#E4E4E4] bg-[#F9FAFB]">
                  <th className="px-4 py-3 text-left text-xs font-medium text-[#525252]">User</th>
